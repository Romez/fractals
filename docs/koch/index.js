...
var ASM_CONSTS = {
  93256: () => { if (document.fullscreenElement) return 1; },  
 93302: () => { return Module.canvas.width; },  
 93334: () => { return parseInt(Module.canvas.style.width); },  
 93382: () => { document.exitFullscreen(); },  
 93409: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93482: () => { if (document.fullscreenElement) return 1; },  
 93528: () => { return Module.canvas.width; },  
 93560: () => { return screen.width; },  
 93585: () => { document.exitFullscreen(); },  
 93612: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93745: () => { return window.innerWidth; },  
 93771: () => { return window.innerHeight; },  
 93798: () => { if (document.fullscreenElement) return 1; },  
 93844: () => { return Module.canvas.width; },  
 93876: () => { return parseInt(Module.canvas.style.width); },  
 93924: () => { if (document.fullscreenElement) return 1; },  
 93970: () => { return Module.canvas.width; },  
 94002: () => { return screen.width; },  
 94027: () => { return window.innerWidth; },  
 94053: () => { return window.innerHeight; },  
 94080: () => { if (document.fullscreenElement) return 1; },  
 94126: () => { return Module.canvas.width; },  
 94158: () => { return screen.width; },  
 94183: () => { document.exitFullscreen(); },  
 94210: () => { if (document.fullscreenElement) return 1; },  
 94256: () => { return Module.canvas.width; },  
 94288: () => { return parseInt(Module.canvas.style.width); },  
 94336: () => { document.exitFullscreen(); },  
 94363: ($0) => { Module.canvas.style.opacity = $0; },  
 94401: () => { return screen.width; },  
 94426: () => { return screen.height; },  
 94452: () => { return window.screenX; },  
 94479: () => { return window.screenY; },  
 94506: () => { return window.devicePixelRatio; },  
 94542: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94595: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94646: () => { Module.canvas.style.cursor = 'none'; },  
 94683: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94939: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94990: () => { if (document.pointerLockElement) return 1; },  
 95037: () => { if (document.fullscreenElement) return 1; },  
 95083: () => { return window.innerWidth; },  
 95109: () => { return window.innerHeight; }
};
